...
public class PhoneNumberActivity extends AppCompatActivity {
    ...
    private void initOTPFlow(String phone) {
        Intent otpIntent = new Intent(PhoneNumberActivity.this, VerifyOTPActivity.class);
    ...
    private void initViews() {
        ...
        et_country_code.setOnShowListener(new EditSpinner.OnShowListener() {
            @Override
            public void onShow() {
                adapter = new ArrayAdapter<String>(PhoneNumberActivity.this, android.R.layout.simple_spinner_dropdown_item,
